        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h1><a href="notice-topic.php?notice_topic_id=<?php echo $rws['notice_topic_id'];?>"><?php echo $rws['notice_topic_name'];?></a></h1>
                    <br>
                    <div class="well">
                        <div class="row clearfix">
                            ...
                            <div class="col-md-11 column">
                                ...
                                <hr>
                                <?php echo $rws['notice_topic_body'];?>    
                            </div>
                        </div>
                    </div>
                </div>
...
?>
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h1><a href="forum-topic.php?forum_topic_id=<?php echo $rws['forum_topic_id'];?>"><?php echo $rws['forum_topic_name'];?></a></h1>
                    <br>
                    <div class="well">
                        <div class="row clearfix">
                            <div class="col-md-1 column">
